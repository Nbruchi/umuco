import pscene from "../assets/3d/palace.glb";
        ...
        >
            <group position={[-72.498, 11.24, -259.011]} scale={3.853}>
                ...
                <mesh
                    ...
                    position={[10.14, 1.301, -3.675]}
                    scale={0.886}
                >
                    <mesh
                        geometry={nodes.GN_Instance001.geometry}
                        material={materials["Wood dark brown"]}
                    />
                </mesh>
                <mesh
                    geometry={nodes.imbehe003.geometry}
                    material={materials["Wood dark brown.001"]}
                    position={[4.397, -1.381, -2.907]}
                    rotation={[0, 0.517, 0]}
                    scale={0.626}
                />
                <mesh
                    geometry={nodes.isekuru001.geometry}
                ...
                />
                <mesh
                    geometry={nodes.umuhini009.geometry}
            ...
            >
                <mesh
                    ...
                    position={[55.995, 1071.672, 14.074]}
            ...
            <mesh
                ...
                position={[-17.911, 37.13, -188.144]}
                rotation={[0, 0.787, -Math.PI / 2]}
                scale={14.973}
            />
            <mesh
                geometry={nodes.bow.geometry}
                material={materials.Huji}
                position={[-3.701, 31.882, -220.513]}
                rotation={[-0.349, 1.447, -3.142]}
                scale={1.372}
            >
                <mesh
            ...
            <mesh
                ...
                position={[-17.247, 38.297, -197.447]}
                rotation={[1.684, 0.061, -1.081]}
                scale={0.554}
            >
                <mesh
            ...
            <mesh
                ...
                position={[-18.602, 38.375, -194.926]}
                rotation={[1.738, 0.089, -1.085]}
                scale={0.566}
            >
                <mesh
            ...
            <mesh
                ...
                material={materials["Cabin Beam Wall Dark Brown Edgewear"]}
                position={[-15.876, 38.281, -199.999]}
                rotation={[1.627, 0.03, -1.079]}
                scale={0.543}
            >
                <mesh
            ...
            <mesh
                ...
                material={materials["Rough Wood"]}
                position={[-14.721, 20.161, -202.149]}
                rotation={[Math.PI / 2, 0, -1.078]}
            ...
            <mesh
                ...
                material={materials["Cabin Beam Wall Dark Brown Edgewear"]}
                position={[-14.196, 20.505, -203.125]}
                rotation={[1.538, -0.017, -1.078]}
            ...
            <mesh
                ...
                material={materials["Rough Wood"]}
                position={[-13.605, 20.395, -204.225]}
                rotation={[1.491, -0.043, -1.079]}
            ...
            <group
                position={[-15.783, 28.594, -189.225]}
